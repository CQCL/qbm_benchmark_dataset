...
def hamiltonian_operators(n: int, label: int) -> list[qu.qarray]:
    ...
    match label:
        ...
        case 1: # 1D Heisenberg model
            h_ops.append(h_two_sites(n, "X") + h_two_sites(n, "Y") + h_two_sites(n, "Z"))
        ...
        case 3: # J1-J2 model
            h_ops.append(h_two_sites(n, "X") + h_two_sites(n, "Y") + h_two_sites(n, "Z"))
            h_ops.append(h_two_sites_j2(n, "X") + h_two_sites_j2(n, "Y") + h_two_sites_j2(n, "Z"))
...
def total_hamiltonian(
        hamiltonian_operators: list[qu.qarray], 
        coeffs: list[float]
    ) -> qu.qarray:
    ...
    """
    assert len(hamiltonian_operators) == len(coeffs), "Mismatch between the lengths of hamiltonian_terms and coeffs!"
    hamiltonian_terms = []
