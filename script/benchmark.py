...
parser.add_argument("--e", type=int, default=200, help="Number of traninig epochs (200)")
...
# As an example, the Gibbs state of TF-Ising model (label=0) is taken to generate data (expectation values)
target_label = 0
target_ham_ops = hamiltonians.hamiltonian_operators(n, target_label)
